          ...
          children: <Widget>[
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceAround, children: [
              for (var i = 0; i < cantidadDeDados; i++)
                Container(
                  child: Image.asset('assets/img/${dados[i]}.png'),
                  width: tamanoDado,
                ),
            ]),
            Padding(
              ...
              child: Text(
                'Usted obtuvo $resultado puntos',
                style: TextStyle(fontSize: 25, color: Colors.white),
              ),
            ),
            RaisedButton(
              onPressed: () => cambiarNumero(),
              color: Colors.white,
